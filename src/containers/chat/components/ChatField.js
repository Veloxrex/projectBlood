...
class ChatField extends PureComponent {
    ...
    componentDidMount = () => {
        window.emojione.imagePathPNG = `https://cdn.jsdelivr.net/emojione/assets/4.0/png/32/`;
    ...
    //     // if(e.key == 'Enter'){
    //     //     console.log(this.state.chatField);
    //     // }
    // }
    ...
    onHandleFileSelect = (e) => {
        ...
        chatRoomActions.uploadImage(selectedFile)
        .then(res => {
