...
import { chatRoomActions } from './../../../redux/actions/chatRoomActions'
class ChatRoomList extends PureComponent {
    ...
    componentDidUpdate = () => {
        console.log(this.props.searchingValue);
    };
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        onGetAllChatRooms: () => {
            dispatch(chatRoomActions.getAll());
        },
        onJoinRoom: (roomName) => {
            dispatch(chatRoomActions.joinRoomRequest(roomName));
        },
        onLeaveRoom: (roomName) => {
            dispatch(chatRoomActions.leaveRoomRequest(roomName));
        },
        onGetAllUsers: () => {
