...
// import $ from 'jquery'
// import x from './../../../../public/img/upload/1.png'
// window.jQuery = $;
// window.$ = $;
// global.jQuery = $;
...
export default class ChatBubble extends PureComponent {
    ...
    componentDidMount = () => {
        ...
        //let id = message.type === 'image' ? message.data : '';
        // $(`#${message.data}`).click(()=>{
        //     alert("hi");
        // })
    };
            ...
            case `image`:
                return (
                    <div className={`chat__bubble-message-wrap ${styleClass} chat__bubble-message-wrap--file`}>
                        ...
                        <img name={`/img/upload/${body}`} src={`/img/upload/${body}`} alt={body} onClick={this.onOpenImage} />
                    </div>
                );
            case `qrcode`:
                return (
